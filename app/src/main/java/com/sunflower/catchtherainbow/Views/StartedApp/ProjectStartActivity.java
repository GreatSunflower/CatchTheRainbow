...
import com.sunflower.catchtherainbow.Views.ViewPagerTransformers.CubeOutTransformer;
...
public class ProjectStartActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        viewPager.setPageTransformer(true, new CubeOutTransformer()); //set the animation
