...
/**
 * Created by Alexandr on 06.03.2017.
 */
...
public class CircularSeekBar extends View {
    ...
    protected void initAttributes(TypedArray attrArray) {
        ...
        mMax = attrArray.getInt(R.styleable.CircularSeekBar_max_seek_bar, DEFAULT_MAX);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        textPaint.setColor(getResources().getColor(R.color.colorForeground));
        textPaint.setTextAlign(Paint.Align.CENTER);
        //textPaint.setTypeface(font);
        textPaint.setTextSize(this.getWidth() / 5);
